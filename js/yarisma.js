  ...
  */  
    if(document.getElementById("soruGetirme").checkValidity() ) 
      {        
            ...
            $.post('http://localhost:8080/bilgiYarisma/service/service.php', {mode :"getSorular"}, 
...
/*
  $("#bitir").click(function(event) {
      ...
      function updatePoint(){
        $.post('http://localhost:8080/bilgiYarisma/service/service.php', {mode:"updatePoint",dogrusayi:dogrusayi,yanlissayi:yanlissayi,userId:localStorage.getItem("userId") }, function(data, textStatus, xhr) {
...
*/
      ...
      function updatePoint(puan,dSayi,ySayi){
        ...
        $.post('http://localhost:8080/bilgiYarisma/service/service.php', {mode:"updatePoint",dogrusayi:dSayi,yanlissayi:ySayi,userId:localStorage.getItem("userId"), puan:puan }, 
        function(data, textStatus, xhr) {
        var data = JSON.parse(data);
        if(data.status)
        { 
